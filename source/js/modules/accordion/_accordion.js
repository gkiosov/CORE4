...
// Accordion Component
// ==========================================
// Accessible collapsible panels with animated height,
// single/multiple mode, expand-all / collapse-all buttons,
// and full event cleanup on destroy.
// ==========================================
...
export class Accordion {
	 ...
	 * @param {string} options.openClass  – CSS class for open state
	 * @param {boolean} options.multiple  – allow multiple open panels
	 */
	...
	// ================================
	// Expand ALL (ignores multiple flag)
	// ================================
	 ...
	 * @param {Object} item  – { item, header, content }
	 * @private
	 */
	_closeInstant(item) {
	...
	/**
	 * Animate close on a sibling when opening in single mode.
	 * @param {Object} item
	 * @private
	 */
	_closeAnimate(item) {
	...
	/**
	 * Animate content height with CSS transition.
	...
	/**
	 * Remove pending transitionend listener.
	 * @param {Element} content
	 * @private
	 */
	...
	/** Remove all listeners, clear transitions, and close all items. */
	destroy() {
...
/**
 * Initialize all accordions matching the selector.
 * @param {string} selector  – CSS selector (default: '[data-accordion]')
 * @returns {Accordion[]}
 */
